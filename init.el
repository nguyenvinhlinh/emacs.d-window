...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet-snippets yasnippet eglot company elixir-mode yaml-mode sudo-edit smex smartparens projectile neotree magit ido-vertical-mode dracula-theme all-the-icons-dired)))
(custom-set-faces
